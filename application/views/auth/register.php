              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="form-group">
                      <input type="text" name= "namalengkap" class="form-control form-control-user" id="namalengkap" aria-describedby="emailHelp" placeholder="Nama Lengkap">
                    </div>
                    <div class="form-group">
                      <input type="text" name= "alamat" class="form-control form-control-user" id="alamat" aria-describedby="emailHelp" placeholder="Alamat">
                    </div>
                    <div class="form-group">
                      <input type="text" name= "notelp" class="form-control form-control-user" id="notelp" aria-describedby="emailHelp" placeholder="No Telepon">
                    </div>
